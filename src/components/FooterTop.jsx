        ...
        <div className="bg-[#2563EB] w-full h-130 sm:h-100 max-w-7xl rounded-lg relative overflow-hidden">
          ...
          <form className="flex flex-col sm:flex-row justify-center items-center gap-3 sm:gap-4 md:gap-5 mt-8 sm:mt-10 md:mt-12 lg:mt-15 mb-12 sm:mb-16 md:mb-20 lg:mb-25 px-5 sm:px-10">
            <input
              ...
              className="w-70 h-15 sm:w-auto bg-transparent text-white placeholder:text-placeholder text-base sm:text-lg md:text-xl border-2 border-white rounded-lg p-3 md:p-4 focus:outline-none focus:border-white focus:ring-2 focus:ring-white transition"
            />
            <input
              type="email"
              placeholder="Email Address"
              className="w-70 h-15 sm:w-auto bg-transparent placeholder:text-placeholder text-white text-base sm:text-lg md:text-xl border-2 border-white rounded-lg p-3 md:p-4 focus:outline-none focus:border-white focus:ring-2 focus:ring-white transition"
            />
