        ...
        <main className='h-full bg-[#A0A3BD33] p-10'>
            <section className='bg-white ml-20 mr-20 rounded-3xl p-15'>
                ...
                <div className='mt-8 flex gap-5'>
                    <select className='text-xl cursor-pointer font-semibold text-[#4E4B66] bg-[#EFF0F6] p-5 pl-15 pr-15 text-left rounded-lg'>
                    ...
                    <button className='text-xl cursor-pointer font-semibold text-white bg-[#1D4ED8] p-5 pl-15 pr-15 text-left rounded-lg'>
                        Filter
                    </button>
                </div>
